...
const Input: React.FC<InputProps> = ({
  ...
  placeholder:text-szBlack700 ${
      error ? "border-error700 focus:ring-szBlack700" : "border-szLightGrey400 focus:ring-szBlack700"
    ...
    return (
        <>
                ...
                {isTextarea ? (
                    <>
                        <textarea
                            ...
                            onChange={onChange}
                            disabled={disabled}
                            className={`${sharedStyles} min-h-[100px] min-w-[300px] resize-none disabled:border-szLightGrey400 disabled:hover:border-szLightGrey400 disabled:opacity-50 disabled:cursor-not-allowed `}
                        />
                    ...
                    <input
                        ...
                        onChange={onChange}
                        disabled={disabled}
                        className={`${sharedStyles} min-h-[44px] disabled:border-szLightGrey400 disabled:hover:border-szLightGrey400 disabled:opacity-50 disabled:cursor-not-allowed `}
                    />
                )}
            ...
            {description && <p className="mt-1 text-caption-reg text-szDarkGrey600 font-dmSan">{description}</p>}
        </>
    );
};
